...
import com.bertelli.pocketls.adapter.NavDrawerListAdapter;
import com.bertelli.pocketls.model.NavDrawerItemModel;
...
public class DrawerMainActivity extends Activity {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		menu.findItem(R.id.action_facebook).setVisible(!drawerOpen);
	...
	private void displayView(int position) {
		...
		case 0:
			...
			break;
		case 1:
			fragment = new AlbunsFragment();
			break;
		case 2:
			fragment = new VideografiaFragment();
			break;
		case 3:
		...
		case 5:
			...
			break;
		case 6:
			fragment = new BiografiaFragment();
			break;
		case 7:
			fragment = new FiqueLigadoFragment();
			break;
		case 8:	
